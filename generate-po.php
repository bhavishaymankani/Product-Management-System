  ...
  <section id="container">
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone">View/Print</th>
                ...
                <tbody>
                  ...
                  <tr class="gradeA">
                    ...
                    <td><a href="po-view.php?id=<?php echo $rows['id'];?>"><button class="btn btn-info btn-xs"><i class="fa fa-eye"></i></button></a></td>
                    <td><a href="po-edit.php?id=<?php echo $rows['id'];?>"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a></td>
                    <td><a href="po-delete.php?id=<?php echo $rows['id'];?>"><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a></td>
                  </tr>
                <?php } ?>
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <a href="generate-po.php#" class="go-top">
