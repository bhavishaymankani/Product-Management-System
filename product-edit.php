        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" name="update_product" action="update-product.php" method="POST">
                <input type="hidden" name="id" value="<?php echo $id ;?>">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Product Name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="prod_name" value="<?php echo $data['product_name'];?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Manufacturer</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="manf"value="<?php echo $data['manufacturer'];?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Packing</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="packing" value="<?php echo $data['packing'];?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">HSN No.</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="hsn" value="<?php echo $data['hsn_no'];?>">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="trd_prc" value="<?php echo $data['trade_price'];?>">
                  </div>
                </div>
                
                <div class="form-group" align="center">
                  <div class="col-sm-10">
                    <input type="submit" name="update_product" class="btn btn-theme " value="Save">
                  </div>
                </div> 
