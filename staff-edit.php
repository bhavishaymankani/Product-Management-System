        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" name="update_department" action="update-staff.php" method="POST">
                <input type="hidden" name="id" value="<?php echo $id ;?>">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Staff Name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="staff_name" value="<?php echo $data['staff_name'];?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Staff's Head</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="staff_head"value="<?php echo $data['staff_head'];?>">
                  </div>
                </div>
